...
16. **Agent4Ranking: Semantic Robust Ranking via Personalized Query Rewriting Using Multi-agent LLM**, _Li et al._, arXiv 2024.  \[[Paper](https://arxiv.org/abs/2312.15450)\]
17. **Crafting the Path: Robust Query Rewriting for Information Retrieval**, _Baek et al._, arXiv 2024.  \[[Paper](https://arxiv.org/abs/2407.12529)\]
